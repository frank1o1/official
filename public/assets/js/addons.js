...
require(['form', 'upload'], function (Form, Upload) {
    ...
    var domain = window.location.origin ? window.location.origin : window.location.protocol;
            ...
            if ($(".tinymce,.editor", form).size() > 0) {
                require(['tinymce'], function () {
                    tinymce.init({
                        ...
                        //width: 600,
                        // height: 250,
                        plugins: ['advlist link image lists charmap hr anchor pagebreak searchreplace wordcount visualblocks visualchars code insertdatetime nonbreaking save table contextmenu directionality help'],//所含插件
