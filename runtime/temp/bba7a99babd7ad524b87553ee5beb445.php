<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"E:\honghai\fastadmin\public/../application/admin\view\news\trends\add.html";i:1547725610;s:63:"E:\honghai\fastadmin\application\admin\view\layout\default.html";i:1547208566;s:60:"E:\honghai\fastadmin\application\admin\view\common\meta.html";i:1547208566;s:62:"E:\honghai\fastadmin\application\admin\view\common\script.html";i:1547208566;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" class="form-control" size="50" name="row[image]" type="text" placeholder="710*350">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-satus_switch" class="form-control selectpicker" name="row[status_switch]">
                ...
                <option value="<?php echo $key; ?>" {in name="key" value="0" }selected{
